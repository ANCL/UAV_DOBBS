...
//-------------------------------Backstepping----------------------------------------
                         ...
                         matrix::Matrix<float, 3, 3> RIRT = R*Ie3*R.T();

                         matrix::Vector<float, 3> uRSwn3 =  u*R*Sw*n3;
                         ...
                         matrix::Vector<float, 3> delta_2_3_dot=m*g*n3-u*R*n3+df_hat-m*ddpd+m*k1*v-m*k1*dpd+k3*(beta-u_dot*R*n3-uRSwn3);
                         ...
                         wddot0= -(n2.T()*R.T())*(alpha_3_dot-u_dot*R*Sw*n3-u*R*Sw*Sw*n3+delta_3+k4*(delta_4))/u;

                         matrix::Matrix<float, 1 , 1>  wddot1;
                         wddot1= (n1.T()*R.T())*(alpha_3_dot-u_dot*R*Sw*n3-u*R*Sw*Sw*n3+delta_3+k4*(delta_4))/u;
