...
//  private int simDelayMax = 500;  // Max delay between simulated and real time to skip samples in simulator, in ms
    ...
    public Simulator() throws IOException, InterruptedException {
        ...
        simpleEnvironment.setWindDeviation(new Vector3d(0.0, 0.0, 0.00));
    ...
    // where to modify the vehicle  system parameters
     ...
     * @param rotorThrust    full thrust of one rotor [N]                  defalut=4
     * @param rotorTorque    torque at full thrust of one rotor in [Nm]    default=0.05
     * @param rotorTimeConst spin-up time of rotor [s]                     default=0.005
     ...
     */
        ...
        sensors.setGPSInterval(30);
        sensors.setGPSDelay(120);
        ...
        sensors.setGPSDelay(80);
        sensors.setNoise_Acc(0.005f);
        sensors.setNoise_Gyo(0.002f);
        sensors.setNoise_Mag(0.002f);
	...
	vehicle.setSensors(sensors, getSimMillis());*/
        ...
        SimpleSensors sensors = new SimpleSensors();
        sensors.setGPSInterval(20);
        sensors.setGPSDelay(30);
        sensors.setNoise_Acc(0.05f);
        sensors.setNoise_Gyo(0.001f);
        sensors.setNoise_Mag(0.001f);
